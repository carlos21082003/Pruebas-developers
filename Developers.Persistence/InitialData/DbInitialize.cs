...
public class DbInitialize : IDbInitialize
{
    ...
    public void Initialize()
    {
        ...
        _userManager.CreateAsync(new ApplicationUser
        {
            ...
            FirstName = "Peter",
            LastName = "Parker"
        }, "Estudiante123*").GetAwaiter().GetResult();

        ApplicationUser estudiante = _context.ApplicationUser.Where(u => u.UserName == "estudiante@correo.com").FirstOrDefault();
        _userManager.AddToRoleAsync(estudiante, DS.Role_Estudiante).GetAwaiter().GetResult();
        ...
        _userManager.CreateAsync(new ApplicationUser
        {
            ...
            FirstName = "Bruce",
            LastName = "Banner"
        }, "Profesor123*").GetAwaiter().GetResult();

        ApplicationUser profesor = _context.ApplicationUser.Where(u => u.UserName == "profesor@correo.com").FirstOrDefault();
        _userManager.AddToRoleAsync(profesor, DS.Role_Empleado).GetAwaiter().GetResult();
    }
}
